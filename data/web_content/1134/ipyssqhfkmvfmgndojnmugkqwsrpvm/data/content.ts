...
export const content: { [key in Language]: Content } = {
  es: {
    ...
    hero: {
      ...
      image: "https://storage.googleapis.com/gastronomio_images/1134/ipyssqhfkmvfmgndojnmugkqwsrpvm/photo_1.jpg",
      cta: "Reservar Mesa"
    },
    menu: {
      title: "Nuestro Menú",
    ...
    about: {
      ...
      image: "https://storage.googleapis.com/gastronomio_images/1134/ipyssqhfkmvfmgndojnmugkqwsrpvm/photo_2.jpg",
      paragraph1: "En Pub cafetería Spay, nos enorgullece ofrecer una experiencia culinaria basada en la tradición y los productos de nuestra tierra. Somos un negocio familiar dedicado a traer los sabores auténticos de la cocina castellana a su mesa.",
    ...
    contact: {
      ...
      embed_url: "https://www.google.com/maps/embed/v1/place?key=AIzaSyDm6MhtGVlGk0laRqDIqYN0dWQwAogjBJs&q=place_id:ipyssqhfkmvfmgndojnmugkqwsrpvm"
    },
    footer: {
  ...
  en: {
    ...
    about: {
      title: "Our Story",
      image: "https://storage.googleapis.com/gastronomio_images/1134/ipyssqhfkmvfmgndojnmugkqwsrpvm/photo_2.jpg",
      paragraph1: "At Pub cafetería Spay, we pride ourselves on offering a culinary experience based on tradition and local products. We are a family business dedicated to bringing the authentic flavors of Castilian cuisine to your table.",
