...
export const content: { [key in Language]: Content } = {
  es: {
    ...
    hero: {
      ...
      image: "https://storage.googleapis.com/gastronomio_images/1134/jzvgcnimtbeqoowlnozdydoarqaium/photo_1.jpg",
      cta: "Reservar Mesa"
    },
    menu: {
      title: "Nuestro Menú",
    ...
    about: {
      ...
      image: "https://storage.googleapis.com/gastronomio_images/1134/jzvgcnimtbeqoowlnozdydoarqaium/photo_2.jpg",
      paragraph1: "En Capri Pub, nos enorgullece ofrecer una experiencia culinaria basada en la tradición y los productos de nuestra tierra. Somos un negocio familiar dedicado a traer los sabores auténticos de la cocina castellana a su mesa.",
    ...
    contact: {
      ...
      address: "Dirección",
      addressValue: "Carrer Major, 43, 46610 Guadassuar Valencia",
      ...
      hours: {
        ...
        viernes: "Viernes: 19:00–1:30",
        sabado: "Sabado: 19:00–1:30",
  ...
  en: {
    ...
    about: {
      title: "Our Story",
      image: "https://storage.googleapis.com/gastronomio_images/1134/jzvgcnimtbeqoowlnozdydoarqaium/photo_2.jpg",
      paragraph1: "At Capri Pub, we pride ourselves on offering a culinary experience based on tradition and local products. We are a family business dedicated to bringing the authentic flavors of Castilian cuisine to your table.",
    ...
    contact: {
      ...
      hours: {
        ...
        viernes: "Friday: 19:00–1:30",
        sabado: "Saturday: 19:00–1:30",
